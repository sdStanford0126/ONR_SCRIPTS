...
def plotTurbProf_C(u,v,w,rho,p,xc,y,z, out_dir = "./",eps=delta/1.9, fig_offset=0):
    ...
    SemiLogXName_fmt = "{}_{}_loglog.png"
    ...
    side_label = "y"
    PlotName = PlotName_fmt.format(var_label,side_label)
    plotProfile(xc,y,ufvf_avg_y/(u_tau_y**2),r"$\frac{\overline{u'v'}}{u_{\tau,y}}$", side_label,PlotName,fig_id)
    ...
    side_label = "z"
    PlotName = PlotName_fmt.format(var_label,side_label)
    plotProfile(xc,z,ufwf_avg_z/(u_tau_z**2),r"$\frac{\overline{u'w'}}{u_{\tau,z}}$", side_label,PlotName,fig_id)
